...
Original file is located at
    https://colab.research.google.com/drive/1j2MMibFfvOdid5fFyRhCIXhByAiGkD_t
...
"""Terdapat 20058 data yang terdapat pada dataset kita, sekarang kita ingin mencari beberapa informasi seperti, banyaknya permainan yang ada, banyaknya pemain putih, pemai hitam, dan banyaknya opening"""
...
"""Tidak terdapat null values pada data, sekarang kita mengecek apakah ada data yang duplikat
...
"""Ternyata ada 945 baris data yang duplikat, sekarang kita akan menghapus data yang duplikat sesuai dengan id permainan
...
## Filter by rating range 1500-2200

Disini kita akan memfilter lagi data yang ada dengan pemain hitam dan putih yang memiliki rentang rating 1500 - 2200.
"""
...
"""Disini saya mau melihat visualisasi penyebaran data baru yang telah kita filter sebelumnya berdasarkan rating pemain dengan rentang rating 1500-2200."""
...
"""Dapat dilihat penyebaran data disini terlihat lebih banyak pada rating pemain 1500an dan dapat disimpulkan bahwa rating pemain 1500an sangat dominan pada data ini

## Menambahkam kolom opening

Disini saya akan memperbaiki kolom opening_name yang memiliki karakter yang kurang bagus untuk dibaca dengan memisahkan karakter - karakter yang ada sehingga mudah dibaca
"""
...
"""## Membuat dataframe opening_used

Disini opening_used berfungsi untuk membuat dataframe baru yang berisi kolom player_id, opening_archetype, times_used untuk melihat player_id yang memainkan opening apa saja dan berapa kali jumlah opening yang dimainkan
"""
...
"""Dapat dilihat disini bahwa opening Sicilian Defense paling banyak di mainkan di dalam data diikutin oleh French Defense, Queen's Pawn Game dan seterusnya.

## Feature Selection

Disini saya membuat feature_selection dari dataframe opening_used
"""
...
# Membuat dataframe baru untuk data ‘player_id’, ‘opening_archetype’, dan ‘times_used’
...
# Membuat salinan dari DataFrame chess_new ke variabel data
data = chess_new
data.sample(5)
...
"""## Membuat rekomendasi untuk Content Based filtering"""
...
"""## Membuat rekomendasi untuk Collaborative Filtering"""
